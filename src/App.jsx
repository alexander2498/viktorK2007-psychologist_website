    ...
    <div>
      ...
      <div>
        <div className='boxBoshka' >
          <Gipnoz text={"Гипноз, и конкретно гуманистический гипноз, — это наиболее бережный метод коммуникации с самим собой, со своей бессознательной частью. Гуманистический гипноз создан Оливье Локером и Патрисией д’Анжели в конце 90-х прошлого века. Гипноз без манипуляций! Это метод, который приводит к изменениям благодаря самопомощи  клиента, а гипнотерапевт является только сопровождающим его или просто осветителем!"} />
          <SvgBoshka />
        </div>
        <div className='boxBoshka' >
          <Cist />
