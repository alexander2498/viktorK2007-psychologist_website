    ...
    return (
        <div style={styles.backgroundForma} >
            <div style={styles.forma} >
                ...
                <div style={styles.flex_contact} class="flex_contact">

                    <div style={styles.how_to_contact} class="how_to_contact"><p>КАК СВЯЗАТЬСЯ</p></div>

                    <div style={styles.contact_text} class="contact_text"><p>КОНТАКТЫ</p></div>
                </div>
                <div class="info_flex" style={styles.infoFlex}>

                    <form onSubmit={sendFeedback}  class="form_box" style={styles.form_box}>
                        <svg class="pismo" style={styles.pismo} width="24" height="18" viewBox="0 0 24 18" fill="none"
                        ...
                        <div class="form_name" style={styles.form_name} >
                            <input type="name" name="name" placeholder="Имя" />
                        </div>
                        <div class="forma_box_flex" style={styles.forma_box_flex}>
                            <div class="form_phone" style={styles.form_phone}>
                                <input type="phone" name="phone" placeholder="Телефон" />
                            </div>
                            <div class="form_email" style={styles.form_email} >
                                <input type="email" name="email" placeholder="Электронная почта" />
                            </div>
                        </div>
                        <div class="form_comment" style={styles.form_comment} >
                            <input type="text" name="comment" placeholder="Ваш коментарий" />
                        </div>
                        <button style={styles.button_zap} type="submit" class="button_zap">
                            <p style={styles.otpr} class="otpr">Отправить</p>
                        </button>
